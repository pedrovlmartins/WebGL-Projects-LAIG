/**
 * Linear Animation following a set of control points.
...
class LinearAnimation extends Animation {
    ...
    animate(t) {
        ...
        */
        ...
        // case for negative angles (the y value is the same if added by PI) and when tan 0 is 0 (which is undefined)	
        if (p2[2] - p1[2] < 0)
